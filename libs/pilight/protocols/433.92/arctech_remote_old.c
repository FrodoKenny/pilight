...
void arctechRemoteOldInit(void) {
   ...
   options_add(&arctech_remote_old->options, 'e', "event", OPTION_HAS_VALUE, DEVICES_VALUE, JSON_NUMBER, NULL, NULL);
   ...
   options_add(&arctech_remote_old->options, 'i', "id", OPTION_HAS_VALUE, DEVICES_ID, JSON_NUMBER, NULL, "^(3[012]?|[012][0-9]|[0-9]{1})$");
